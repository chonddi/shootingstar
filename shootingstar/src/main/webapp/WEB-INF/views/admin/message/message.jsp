...
<script type="text/javascript">
	$(function(){
		...
		$('#sendMsg').click(function(){
			...
			window.open("<c:url value='/admin/message/messageWrite.do'/>","쪽지보내기","left=" + x + ", top=" + y + ", width=460, height=600, location=yes, resizable=no");
		});
	});
	...
	function msgViewSubmit(){
		...
		frm.action = "<c:url value='/admin/message/messageDetail.do'/>";
		frm.target = "viewer";
		frm.method = "post";
		frm.submit();
	}
