		...
		<div id="detailArticleBottom">
			...
			<div id="detailArticleSide">
				...
				<button type="button" class="btn btn-default btn-lg">
  					<span class="glyphicon glyphicon-star" aria-hidden="true"></span> 이 전문가에게 문의하기
				</button>
				<div id="likeBox">
					<hr>
					<span>♡ 좋아요</span>
					...
					<div id="star">
						<table id="starTable" border="1" width="900px">
							<tr>
								...
								<td>총평점  <input type="hidden" class="rating" data-readonly value="1"/></td>
								<td>결과물<input type="hidden" class="rating" data-readonly value="3"/>	</td>
								<td>커뮤니케이션	<input type="hidden" class="rating" data-readonly value="5"/></td>
							</tr>
						</table>
					</div>
			</div>
			<div class="comment2">
				<img alt="이미지" src="../images/로고최종글자없이20180719142549736.png" width="120px">
				<div class="memberCommentDiv">
					<span class="memberComment">멤버가 작성한 코멘트가 들어갑니다.</span><br>
					<span class="memberInfo">★9.8 <span class="memberInfo1">멤버이름  | 멤버관심사 | 작성일 | 전문가이름</span></span>
				</div>
			</div>
			<div class="comment2">
				<img alt="이미지" src="../images/로고최종글자없이20180719142549736.png" width="120px">
