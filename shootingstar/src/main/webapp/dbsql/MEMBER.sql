...
CREATE TABLE SMEMBER (
	...
	IDENTIFICATION VARCHAR2(50), /* 신분증 */
	ACCOUNTCOPY VARCHAR2(50), /* 계좌사본 */
	REGDATE DATE DEFAULT SYSDATE, /* 가입일 */
	OUTDATE DATE, /* 탈퇴일 */
...
/* 후기 */
CREATE TABLE REVIEW (
	REVIEWNO NUMBER(10) primary key, /* 후기글번호 */
	PFNO NUMBER(10) NOT NULL, /* 포폴글번호 */
	CONTENT VARCHAR2(2000) NOT NULL, /* 내용 */
	COMMUNICATION NUMBER(2) DEFAULT 0, /* 커뮤니케이션 */
	RESULT NUMBER(2) DEFAULT 0, /* 결과만족도 */
	MEMBERID VARCHAR2(50) NOT NULL, /* 고객ID */
	REGDATE DATE DEFAULT SYSDATE /* 등록일 */
);
...
CREATE TABLE RQPAYMENT (
	...
	PMETHOD VARCHAR2(20), /* 결제방법 */
	PPRICE NUMBER(10), /* 결제금액 */
	MILEAGE NUMBER(10) DEFAULT 0, /* 마일리지사용금액 */
	REGDATE DATE DEFAULT SYSDATE, /* 결제일 */
	CANCEL DATE, /* 결제취소일 */
