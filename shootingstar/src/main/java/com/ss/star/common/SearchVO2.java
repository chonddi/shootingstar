...
public class SearchVO2 {
   ...
   /**
    ...
    public int getSearchCtg() {
    	return searchCtg;
    }
    
    public void setSearchCtg(int searchCtg) {
