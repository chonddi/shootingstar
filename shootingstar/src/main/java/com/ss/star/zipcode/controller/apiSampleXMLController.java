...
public class apiSampleXMLController {
	private Logger logger = LoggerFactory.getLogger(apiSampleXMLController.class);
    ...
    public void getAddrApi(HttpServletRequest req, ModelMap model, HttpServletResponse response) throws Exception {
		...
		logger.info("currentPage: {}, countPerPage: {}", currentPage, countPerPage);
		logger.info("confmKey: {}, keyword: {}", confmKey, keyword);
