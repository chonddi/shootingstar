...
@Component
public class LoginInterceptorQNA extends HandlerInterceptorAdapter {
	
	private static final Logger logger = LoggerFactory.getLogger(LoginInterceptorQNA.class);
